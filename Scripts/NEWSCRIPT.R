...
install_github("allisonhorst/palmerpenguins", dependencies=TRUE) #installing development version of dataset
...
#   [1] forcats_0.5.1   stringr_1.4.0   dplyr_1.0.8     purrr_0.3.4     readr_1.4.0     tidyr_1.2.0     tibble_3.1.6   
# [8] ggplot2_3.3.5   tidyverse_1.3.1
# 
# loaded via a namespace (and not attached):
#   [1] Rcpp_1.0.5       cellranger_1.1.0 pillar_1.7.0     compiler_4.0.3   dbplyr_2.1.1     tools_4.0.3     
# [7] lubridate_1.8.0  jsonlite_1.8.0   lifecycle_1.0.1  gtable_0.3.0     pkgconfig_2.0.3  rlang_1.0.2     
# [13] reprex_2.0.1     DBI_1.1.0        cli_3.2.0        rstudioapi_0.13  haven_2.3.1      xml2_1.3.2      
# [19] withr_2.3.0      httr_1.4.2       fs_1.5.0         generics_0.1.0   vctrs_0.3.8      hms_1.1.1       
# [25] grid_4.0.3       tidyselect_1.1.2 glue_1.4.2       R6_2.5.0         fansi_0.4.1      readxl_1.3.1    
# [31] modelr_0.1.8     magrittr_2.0.2   backports_1.1.10 scales_1.1.1     ellipsis_0.3.2   rvest_1.0.2     
# [37] assertthat_0.2.1 colorspace_1.4-1 utf8_1.1.4       stringi_1.5.3    munsell_0.5.0    broom_0.7.12    
# [43] crayon_1.5.1   
